...
HELP_PIC = Var.HELP_PIC or "https://telegra.ph/file/28ed48fae7e23192af2cc.jpg"
...
async def cmd_list(event):
    ...
    if tgbotusername is None or input_str == "text":
        ...
        if input_str in CMD_LIST:
            ...
            await event.edit(f'{input_str} 𝙸𝚂 𝙽𝙾𝚃 𝙰 𝚅𝙰𝙻𝙸𝙳 𝙿𝙻𝚄𝙶𝙸𝙽!!')
    else:
