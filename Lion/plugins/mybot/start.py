    ...
    if LOAD_MYBOT == "False":
        ...
        if BOT_PIC:
            await tgbot.send_file(event.chat_id,
                                  ...
                                  buttons=[
                                      [Button.url(
                                          "Lion", url="https://github.com/TeamLion-X/Lion-Y")],
                                      [Button.inline(
...
async def settings(event):
    await event.edit("Browse through the available options:",
                     buttons=[
                         [(Button.url("Repository", url="https://github.com/TeamLion-X/Lion-Y")),
                          (Button.url("Deploy", url="https://dashboard.heroku.com/new?template=https://github.com/TeamLion-X/Lion-Y"))],
                         [Button.url("Support",
                                     url="https://t.me/LionXSupport")]
                     ])
