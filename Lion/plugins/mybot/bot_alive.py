...
pm_caption += "► **Lɪᴏɴ X ʟɪᴄᴇɴsᴇ** : [GNU General Public License v3.0](https://github.com/teamlion-X/Lion-Y/blob/master/LICENSE)\n"
pm_caption += "► **Cᴏᴘʏʀɪɢʜᴛ** :[LɪᴏɴX](https://github.com/teamlion-X/Lion-Y)\n"
light = [[Button.url("✧ʀᴇᴘᴏsɪᴛᴏʀʏ✧",
                     "https://github.com/teamlion-X/Lion-Y"),
